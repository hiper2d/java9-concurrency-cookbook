...
class Reader(private var pricesInfo: PricesInfo): Runnable {
    override fun run() {
        (1..20).forEach {
...
class Writer(private var pricesInfo: PricesInfo): Runnable {
...
fun main(args: Array<String>) {
    val info = PricesInfo()
    val reader = Reader(info)
    val writer = Writer(info)
